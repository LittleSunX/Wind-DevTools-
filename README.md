...
代码画布支持 **28 种语言与格式**，语言可搜索，编辑区支持高亮、缩进、撤销和查找。四套风格预设搭配明暗主题、渐变与透明背景，支持行号、字号和窗口标题设置。支持指定画布宽度和长行自动换行，预览可独立缩放。提供 **1× / 2× / 3× PNG** 和图片复制，下载文件按日期时间命名，无水印。
...
![代码画布：代码编辑、外观设置与实时预览](docs/images/code-image.jpg)
